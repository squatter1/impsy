...
\input{2-background}                    % background/framework of necessary formal techniques used
\input{3-relatedWork}                   % related work
\input{4-implementation}                % explain heuristics made and any other code and implementation details
\input{5-evaluation}                    % evaluation
\input{6-futureWork}                    % future work
